...
const styles = {
  ...
  dupBtn: { flex: 1, background: '#d1fae5', border: 'none', color: '#065f46', fontSize: 12, fontWeight: 600, cursor: 'pointer', padding: '4px 9px', borderRadius: 5, lineHeight: 1 },
  deleteBtn: { flex: 1, background: '#fee2e2', border: 'none', color: '#b91c1c', fontSize: 12, fontWeight: 600, cursor: 'pointer', padding: '4px 9px', borderRadius: 5, lineHeight: 1 },
  ...
  editActions: { display: 'flex', flexDirection: 'column', gap: 6 },
  saveBtn: { width: '100%', background: '#059669', color: '#fff', border: 'none', padding: '5px 12px', borderRadius: 5, fontSize: 11, fontWeight: 600, cursor: 'pointer' },
  cancelBtn: { width: '100%', background: 'none', border: '1px solid #d1d5db', color: '#6b7280', padding: '5px 12px', borderRadius: 5, fontSize: 11, cursor: 'pointer' },
};
