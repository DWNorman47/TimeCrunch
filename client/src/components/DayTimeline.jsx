...
const s = {
  ...
  empty: { fontSize: 14, color: '#9ca3af', margin: 0 },
  ...
  timeLabel: { fontSize: 11, color: '#9ca3af', fontVariantNumeric: 'tabular-nums' },
  ...
  closeBtn: { background: 'none', border: 'none', cursor: 'pointer', color: '#9ca3af', fontSize: 16, padding: 0, lineHeight: 1 },
  ...
  dash: { color: '#9ca3af', flexShrink: 0, fontSize: 14 },
  switchRow: { display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 },
  switchArrow: { fontSize: 11, color: '#9ca3af', flexShrink: 0, whiteSpace: 'nowrap' },
