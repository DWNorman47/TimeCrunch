...
const styles = {
  ...
  logoTagline: { fontSize: 10, fontWeight: 500, color: '#6b7280', letterSpacing: '0.04em' },
  ...
  heroNote: { fontSize: 13, color: '#6b7280', marginBottom: 40 },
  ...
  annualNote: { textAlign: 'center', fontSize: 13, color: '#6b7280', marginTop: 28 },
  ...
  faqChevron: { fontSize: 16, color: '#6b7280', flexShrink: 0, transition: 'transform 0.2s' },
  ...
  footerTagline: { fontSize: 10, color: '#6b7280', letterSpacing: '0.04em' },
  footerCopy: { fontSize: 13, color: '#6b7280' },
