      ...
      <main id="main-content" style={styles.main} className="admin-main">
        ...
        {loading ? (
          ...
          <Suspense fallback={<TabLoader />}>
            ...
            {!collapsedSections.payroll && (plan.hasQbo ? <CertifiedPayroll projects={projects} requireSignature={plan.hasCertifiedPayroll && settings?.cp_require_signature !== false} /> : <UpgradePrompt requiredPlan="qbo" feature={t.payrollLabel} />)}
